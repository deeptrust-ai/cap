...
async def poller(id: str, mention_tweet_id: int):
    ...
    tweet1, tweet2 = _parse_tweet(scores[0])
...
"""
#     tweet2 = f"""Deepfake Speech Heatmap Generated By ䷼ @deeptrustAI

# ============
# Disclaimer: DeepTrust Speech is in early alpha. Research is still undergoing. Results may vary.
# """

    tweet2 = "Deepfake Speech Heatmap generated by ䷼ @deeptrustAI"
